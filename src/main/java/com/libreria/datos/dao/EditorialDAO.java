...
public interface EditorialDAO extends
		CrearDAO<EditorialEntidad>,
		ConsultarTodosDAO<EditorialEntidad>,
		ConsultarPorIdDAO<EditorialEntidad, UUID>,
		ConsultarPorFiltroDAO<EditorialEntidad>,
		ActualizarDAO<EditorialEntidad, UUID>,
		EliminarDAO<UUID> {
