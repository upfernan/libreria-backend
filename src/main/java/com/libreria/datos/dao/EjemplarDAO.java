...
public interface EjemplarDAO extends
		CrearDAO<EjemplarEntidad>,
		ConsultarTodosDAO<EjemplarEntidad>,
		ConsultarPorIdDAO<EjemplarEntidad, UUID>,
		ConsultarPorFiltroDAO<EjemplarEntidad>,
		ActualizarDAO<EjemplarEntidad, UUID>,
		EliminarDAO<UUID> {
