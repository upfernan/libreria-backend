...
public class MultaDTO {
	...
	private boolean pagadaTieneValorPorDefecto;
	...
	private MultaDTO(final Builder builder) {
		...
		setPagada(builder.pagada, builder.pagadaTieneValorPorDefecto);
	...
	public boolean isPagadaTieneValorPorDefecto() {
		return pagadaTieneValorPorDefecto;
	}
	...
	public void setPagadaTieneValorPorDefecto(boolean pagadaTieneValorPorDefecto) {
		this.pagadaTieneValorPorDefecto = pagadaTieneValorPorDefecto;
	}
	...
	private void setPagada(final boolean pagada, final boolean pagadaTieneValorPorDefecto) {
		this.pagada = pagada;
		this.pagadaTieneValorPorDefecto = pagadaTieneValorPorDefecto;
	}
	...
	public static class Builder {
		...
		private DevolucionDTO devolucion;
		private UsuarioDTO usuarioAfectado;
		private boolean pagadaTieneValorPorDefecto = true;
		...
		public Builder pagada(final boolean pagada) {
			this.pagada = pagada;
			this.pagadaTieneValorPorDefecto = false;
			return this;
		}
