...
public class UsuarioDTO {
    ...
    private void setTipoIdentificacion(final TipoIdentificacionDTO tipoIdentificacion) {
        this.tipoIdentificacion = UtilObjeto.obtenerValorDefecto(tipoIdentificacion, new TipoIdentificacionDTO.Builder().build());
    }
    ...
    public static class Builder {
        ...
        public Builder tipoIdentificacion(final TipoIdentificacionDTO tipoIdentificacion) {
            this.tipoIdentificacion = UtilObjeto.obtenerValorDefecto(tipoIdentificacion, new TipoIdentificacionDTO.Builder().build());
            return this;
        }
