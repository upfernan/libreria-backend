...
public class TipoIdentificacionEntidad {
    ...
    private TipoIdentificacionEntidad(final Builder builder) {
        setId(builder.id);
    ...
    public static class Builder {
        ...
        public Builder descripcion(final String descripcion) { this.descripcion = UtilTexto.aplicarTrim(descripcion); return this; }
        public TipoIdentificacionEntidad build() { return new TipoIdentificacionEntidad(this); }
    }
}
