...
public class UsuarioDominio {
    ...
    private void setTipoIdentificacion(final TipoIdentificacionDominio tipoIdentificacion) {
        this.tipoIdentificacion = UtilObjeto.obtenerValorDefecto(tipoIdentificacion, new TipoIdentificacionDominio.Builder().build());
    }
    ...
    public static class Builder {
        ...
        public Builder tipoIdentificacion(final TipoIdentificacionDominio tipoIdentificacion) {
            this.tipoIdentificacion = UtilObjeto.obtenerValorDefecto(tipoIdentificacion, new TipoIdentificacionDominio.Builder().build());
            return this;
        }
